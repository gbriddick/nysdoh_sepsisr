...
`nysdoh_sepsisr` allows you to import data collected through NYSDOH's Sepsis Data Collection 
   process, provide internal validation, and generate reports on Sepsis.
...
The `nysdoh_sepsisr` package can be installed from GitHub using the `devtools` package
